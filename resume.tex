...
\begin{itemize}
    ...
    \item
        ...
        \\
        \headerrow
            {\emph{Teaching Assistant for 15214 and 15437}}
            {\emph{Fall 2013/Fall 2014}}
        \begin{itemize*}
            \item 15214 - Principles of Software Construction
            \item 15437 - Web Application Development

            \item Held duties including creating course content, grading,
...
\begin{itemize}
    \item
        \headerrow
            {\textbf{Gameboy Color Hardware Implementation}}
            {\textbf{Fall 2014}}
        \\
        \headerrow
            {\emph{CMU 18545}}
            {\emph{Verilog, Virtex 5 FPGA}}
        \begin{itemize*}
            \item Designed and implemented a working hardware implementation of
                the Nintendo Gameboy Color game console based on behavioral
                specifications.

            \item End result was capible of successfully of playing a large
                fraction of Gameboy color games loaded from ROM files.

            \item Won the class award for best project
        \end{itemize*}
